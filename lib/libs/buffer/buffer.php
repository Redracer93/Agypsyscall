...
class CBBufferApp {
    ...
    function __construct($client_id = '', $client_secret = '', $callback_url = '', $access_token = false ) {
    ...
    function retrieve_access_token() {
        //$this->access_token = isset( $_SESSION['oauth']['buffer']['access_token'] ) ? $_SESSION['oauth']['buffer']['access_token'] : false; // it will be like '1/8b5973c5567y8un78uacc3fb9ikh5e82'
